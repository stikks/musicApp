...
Route::get('playlists/{id}', 'HomeController@index')->middleware('prerenderIfCrawler:playlist');
Route::get('playlists/{id}/{name}', 'HomeController@index')->middleware('prerenderIfCrawler:playlist');

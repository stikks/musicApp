...
//        Group::class        => \App\Policies\GroupPolicy::class,
    ...
    private function registerCustom()
    {
        ...
        $this->app->bind('App\UserConnection', function($app) {
            return new UserConnection($app->make('App\DataSources\MemCached'));
        });

        // adding custom provider
        $this->app['auth']->provider('custom', function ($app, $config) {
            return new CustomProvider($app->make('App\UserConnection'), new ApiRequest());
        });

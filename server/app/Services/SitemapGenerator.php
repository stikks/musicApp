...
class SitemapGenerator {
    ...
    {
        $this->addNewLine(false, false, $this->storageUrl, $this->getItemUpdatedAtTime());
        $this->addNewLine(false, false, $this->storageUrl.'new-releases', $this->getItemUpdatedAtTime());
        $this->addNewLine(false, false, $this->storageUrl.'popular-genres', $this->getItemUpdatedAtTime());
        $this->addNewLine(false, false, $this->storageUrl.'top-songs', $this->getItemUpdatedAtTime());
        $this->addNewLine(false, false, $this->storageUrl.'top-albums', $this->getItemUpdatedAtTime());

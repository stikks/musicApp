...
describe('LoginComponent', () => {
    ...
    it('fills in credentials and logs user in', fakeAsync(() => {
        ...
        testBed.typeIntoEl('#username', 'foo@bar.com');
        ...
        expect(testBed.component.model.username).toEqual('foo@bar.com');
    ...
    it('renders errors', () => {
        testBed.component.errors = {username: 'foo', password: 'bar', general: 'qux'};
        testBed.fixture.detectChanges();

        expect(testBed.find('.general-error').textContent).toEqual('qux');
        expect(testBed.find('.username-error').textContent).toEqual('foo');
